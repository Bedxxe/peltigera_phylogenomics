...
rna_seq=${14} # Indicate the program if you are trying to assemble a RNA_seq sample(s)
...
#SBATCH --partition=${par} # Partition to be used to run the script
        ...
        -k 21,29,39,49,59,79,97,105,117 -m ${total_ram} \
         ...
         # FOR PLASMIDS
            if [ ${plasmid} = "yes" ];
                then
                    ...
                    -k 21,29,39,49,59,79,97,105,117 -m ${total_ram} ${metagenome} --plasmid
                else
